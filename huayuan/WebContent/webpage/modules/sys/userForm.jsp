...
<head>
	...
	<script type="text/javascript">
		...
		/*  
			function $("check"){return document.getElementById();} 
			*/
			function go()
			{
			var reg=/^[1-9]{1}[0-9]{14}$|^[1-9]{1}[0-9]{16}([0-9]|[xX])$/;
			if(reg.test(document.getElementById("check").value))
			{}
			else{alert("身份证号格式不正确");}
			}
		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
		      ...
		      <tr>
					...
					<td class="width-35">
						<form:input path="card" id="check" onchange="go()" htmlEscape="false" class="form-control required"/>
					</td>
