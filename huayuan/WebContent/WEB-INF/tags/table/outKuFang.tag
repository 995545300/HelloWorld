...
<button class="btn btn-white btn-sm" onclick="outKuFangAll()" data-toggle="tooltip" data-placement="top"><i class="fa fa-level-down"> ${label==null?'出库':label}</i>
                        </button>
	...
	function outKuFangAll(){
		...
		// var url = $(this).attr('data-url');
		  ...
		  if(ids == ""){
			...
			top.layer.confirm('确认要批量出库吗?', {icon: 3, title:'系统提示'}, function(index){
