...
public class LoginController extends BaseController{
	 ...
	 * @throws IOException 
	 */
	@RequestMapping(value = "${adminPath}/login01")
	public String login01(HttpServletRequest request, HttpServletResponse response, Model model) throws IOException {
		//Principal principal = UserUtils.getPrincipal();
		String name=request.getParameter("username");
		String password=request.getParameter("password");
		User tuser=new User();
		tuser=UserUtils.getByLoginName(name);
		//System.out.println(tuser.getPassword());
		/*String pas="";
		pas=tuser.getPassword();*/
		System.out.println(tuser);
		if(!(tuser==null)){
			
			boolean flag=SystemService.validatePassword(password,tuser.getPassword());
			
			
			if(flag){
				System.out.println("跳转到二级登录页面");
				return "modules/sys/sysLogin";
			}else{
				System.out.println("跳转到一级登录页面");
				return "redirect:modules/sys/sysLogintwo";
			}
		}
		return "redirect:modules/sys/sysLogintwo";
	}
...
//		System.out.println("==========================b");
	...
	public String home(HttpServletRequest request, HttpServletResponse response, Model model) throws IOException {
		HuaYuanDocument huaYuanDocument = new HuaYuanDocument();
